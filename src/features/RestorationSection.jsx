  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
      ...
      <div className="flex-1 text-left">
        ...
        <h2 className="text-[24px] lg:text-[32px] font-lora leading-[1.3] mb-4 text-black">
          Stop Masking Symptoms. Start Restoring Root Cause.
        </h2>

        <div className="space-y-3 text-[18px] font-nunito leading-[1.3] text-[#333] pb-3">
          <p>
      ...
      {/* Cột bên phải: Lưới hình ảnh kết quả */}
